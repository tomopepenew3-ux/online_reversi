    ...
    for (let r = 0; r < 8; r++) {
        for (let c = 0; c < 8; c++) {
            ...
            if (board[r][c] === BLACK_CAT) {
                ...
                piece.className = 'piece black'; // style.css の黒猫クッキーを適用
                cell.appendChild(piece);
            } else if (board[r][c] === WHITE_CAT) {
                const piece = document.createElement('div');
                piece.className = 'piece white'; // style.css の白猫クッキーを適用
                cell.appendChild(piece);
            }
